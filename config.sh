...
export table_dir="$root/data/$current_db" # this variable will hold the path to the tables directory of the currently connected database, it will be used in all table operations to know where to create, delete, list tables
